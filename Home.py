...
def main_page():
    ...
    with Img_col:
        ...
        social_col1, social_col2 = st.columns(spec=(1, 1), gap="large")
        with social_col1:
            st.link_button("Github👨‍💻", use_container_width=True, url="https://github.com/palakbansa05")

        with social_col2:
            st.link_button("Linkedin🧑‍💼",use_container_width=True,url = "https://www.linkedin.com/in/palak-bansal-58b845339/")
